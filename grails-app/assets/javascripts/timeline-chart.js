        ...
        var groupLabels = svg.selectAll('.group-label').data(data).enter()
          .append('svg:image')
            ...
            .attr("xlink:href", function(d, i) {
              console.log(d.label);
              if(d.label == "1") return "/assets/home.png";
              else if(d.label == "2") return "/assets/house-visiting.png";
              else if(d.label == "3") return "/assets/family-under-a-ceiling-outline.png";
              else if(d.label == "4") return "/assets/party-in-house.png";
              else if(d.label == "5") return "/assets/university.png";
              else if(d.label == "6") return "/assets/work.png";
              else if(d.label == "7") return "/assets/park.png";
              else if(d.label == "8") return "/assets/shopping-cart-empty-side-view.png";
              else if(d.label == "9") return "/assets/silhouette-crossing-street.png";
              else return "/assets/global-map.png";
            });
